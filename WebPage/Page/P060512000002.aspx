<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P060512000002.aspx.cs" Inherits="P060512000002" %>
...
<%--        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
            <ContentTemplate>--%>
                <table width="100%" border="0" cellpadding="0" cellspacing="1">
                    <tr>
                        <td>
                            <%-- <rsweb:ReportViewer ID="ReportViewer0512" runat="server" Height="550px" Width="100%" --%>
