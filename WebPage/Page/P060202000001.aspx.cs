...
public partial class P060202000001 : PageBase
{
    ...
    protected void grvUserView_RowEditing(object sender, GridViewEditEventArgs e)
    {
        try
        {
            ...
            if (null != hidvalue && hidvalue.Value.Equals("A"))
            {
                ...
                Response.Redirect("P060202000003.aspx?action=" + strAction + " &id=" + strId + "&cardno=" + strCardNo + "", false);
            }
            else
            {
                ...
                //* 進入非強迫新增畫面
                Response.Redirect("P060202000002.aspx?action=" + strAction + " &id=" + strId + "&cardno=" + strCardNo + "&trandate=" + strTrandate + "", false);
            }
        }
        catch (Exception exp)
        {
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("P060202000003.aspx");
    }
}
