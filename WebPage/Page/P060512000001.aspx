                        ...
                        <td colspan="2">
                            <li>
                                <cc1:CustLabel ID="lblTitle" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    ...
                                    SetBreak="False" SetOmit="False" ShowID="06_06051200_000" StickHeight="False"></cc1:CustLabel>
                            </li>
                        </td>
                    </tr>
                    <tr class="trOdd">
...
<cc1:CustLinkButton id="lbcardfile" runat="server" Text='<%# Bind("card_file") %>' __designer:wfdid="w1" OnClick="lbcardfile_Click">
                ...
                <asp:Panel ID="PanM" CssClass="workingArea" runat="server" Style="display: none;"
                            ...
                            <td colspan="2">
                                <li id="li3">
                                    <cc1:CustLabel ID="CustLabel49" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="False" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="06_06051200_013" StickHeight="False"></cc1:CustLabel></li>
                            </td>
                        </tr>
                    </table>
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" id="Table2">
                        <tr>
                            <td >
                            <%--     <rsweb:reportviewer id="ReportViewer0512" runat="server" height="400px" width="100%" --%>
