<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P060205000002.aspx.cs" Inherits="P060205000002" %>
                    ...
                    <td style="height: 25px">
                        <li>
                            <cc1:CustLabel ID="lblTitle" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                ...
                                SetBreak="False" SetOmit="False" ShowID="06_06020501_000" StickHeight="False"></cc1:CustLabel></li></td>
                </tr>
                <tr>
                    <td >
                       <%-- <rsweb:ReportViewer ID="ReportViewer0205" runat="server" Height="434px" Width="980px" --%>
