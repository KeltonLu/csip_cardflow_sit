                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="1">
                        ...
                        <td colspan="2" style="height: 25px">
                            <li>
                                <cc1:CustLabel ID="lblTitle" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    ...
                                    SetBreak="False" SetOmit="False" ShowID="06_06020700_000" StickHeight="False"></cc1:CustLabel></li></td>
                    </tr>
                    <tr class="trEven">
                    ...
                    <tr align="center" class="itemTitle">
                        <td colspan="2">
                            ...
                            <cc1:CustButton ID="btnSearch" runat="server" class="smallButton" Style="width: 50px;" ShowID="06_06020700_006" OnClick="btnSearch_Click" />
                        </td>
                    </tr>
                </table>
            </ContentTemplate>
