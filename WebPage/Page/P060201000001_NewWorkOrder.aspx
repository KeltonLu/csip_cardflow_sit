<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P060201000001_NewWorkOrder.aspx.cs" Inherits="P060201000001_NewWorkOrder" %>
                        ...
                        <td colspan="4">
                            <li>
                                <cc1:CustLabel ID="lblTitle" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    ...
                                    SetBreak="False" SetOmit="False" ShowID="06_06020100_008" StickHeight="False"></cc1:CustLabel></li></td>
                    </tr>
                    <tr class="trOdd">
                        ...
                        <td align="right" style="height: 25px;width:15% ">
                            <cc1:CustLabel ID="CustLabel1" runat="server" FractionalDigit="2" IsColon="True"
                                IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0" SetBreak="False"
                                SetOmit="False" StickHeight="False" ShowID="06_06020100_001" CurAlign="left"
                                CurSymbol="£"></cc1:CustLabel></td>
                        <td  style="height: 25px;width:35%">
                     ...
                     <tr class="trEven">
                        <td align="right"  style="height:25px;width:15%">
                            <cc1:CustLabel ID="CustLabel2" runat="server" FractionalDigit="2" IsColon="True"
                                IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0" SetBreak="False"
                                SetOmit="False" StickHeight="False" ShowID="06_06020100_005" CurAlign="left"
                                CurSymbol="£"></cc1:CustLabel></td>
                        <td style="height:25px;width:85%" colspan="3">
                            <cc1:CustTextBox ID="txtMailNo" MaxLength="6" runat="server" InputType="String" Width="174px"></cc1:CustTextBox></td>
                        
                    </tr>
                    <tr align="center" class="itemTitle">
                        <td colspan="4">
                            <cc1:CustButton ID="btnSearch" runat="server" class="smallButton" Style="width: 50px;"
                                ShowID="06_06020100_002" OnClick="btnSearch_Click" />&nbsp;&nbsp;
                            <cc1:CustButton ID="btnAdd" runat="server" class="smallButton" Style="width: 50px;"
                                ShowID="06_06020100_009" OnClick="btnAdd_Click" /></td>
                    </tr>
                </table>
...
<%--新增轉檔日欄位(Wallace) begin--%>
                                    <asp:BoundField DataField="Trandate">
