...
namespace ESBOrderUp
{
	public class ESBOrderUpClass : ESBObject
	{
		...
		public string CDM_C0701_MEMO { get; set; }
		...
		public override string getXML()
		{
			...
			string USERNAME = UtilHelper.GetAppSettings("ESB_USERNAME_INPUTXML");
