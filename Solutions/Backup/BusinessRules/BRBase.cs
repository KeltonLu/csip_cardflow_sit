...
namespace BusinessRules
{
    ...
    public abstract class BRBase<T> where T : Framework.Data.OM.Entity
    {
        ...
        public static void SaveLog(string Message)
        {
            ...
            Logging.SaveLog(ELogLayer.BusinessRule, strErrMsg, ELogType.Error);
        }
        ...
        public static void SaveLog(Exception exp)
        {
            ...
            //Logging.SaveLog(ELogLayer.BusinessRule, "Type:" + typeof(T).ToString() + "," + exp.Message, ELogType.Fatal);
            Logging.SaveLog(ELogLayer.BusinessRule, strErrMsg, ELogType.Fatal);
        }
